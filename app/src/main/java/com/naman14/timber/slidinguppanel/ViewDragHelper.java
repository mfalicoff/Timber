...
public class ViewDragHelper {
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            resetState(); // Reset for a new event stream
        }
        ...
        switch (action) {
            ...
            case MotionEventCompat.ACTION_POINTER_DOWN:
                handleActionPointerDown(ev, MotionEventCompat.getActionIndex(ev));
                break;
            case MotionEvent.ACTION_MOVE:
                handleActionMove(ev);
                break;
            case MotionEventCompat.ACTION_POINTER_UP:
                handleActionPointerUp(ev, MotionEventCompat.getActionIndex(ev));
                break;
    ...
    private void handleActionPointerDown(MotionEvent ev, int actionIndex) {
    ...
    private void handleActionPointerUp(MotionEvent ev, int actionIndex) {
        final int pointerId = MotionEventCompat.getPointerId(ev, actionIndex);
        clearMotionHistory(pointerId);
    }

    private void handleActionCancel() {
        cancel(); // Reset or release resources
    }
